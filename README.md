<div style="margin-top: 20px; font-family: Arial, sans-serif; line-height: 1.8;">
  ...
  <!-- Links Section -->
  <div style="display: flex; justify-content: center; gap: 30px; margin-bottom: 20px; padding: 10px; background-color: #f9f9f9; border: 1px solid #ddd;">
...
<div style="margin-top: 20px; font-family: Arial, sans-serif; line-height: 1.6;">
